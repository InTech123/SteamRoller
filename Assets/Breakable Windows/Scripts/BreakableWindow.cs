...
public class BreakableWindow : MonoBehaviour {
    ...
    private void generateSingleSplinter(int[] tris, Transform parent)
    {
        ...
        rigid.AddForce(new Vector3(Random.value > 0.5f ? Random.value * force : -Random.value * force, Random.value > 0.5f ? Random.value * 50 : -Random.value * 50, Random.value > 0.5f ? Random.value * force : -Random.value * force));
